...
// Carga de fuentes (Asegurate que los nombres de archivo sean exactos)
...
export default function LandingPandaDJ() {
  ...
  return (
    // IMPORTANTE: Agregamos fontCuerpo.className aquí para que aplique a toda la web
    <div className={`${fontCuerpo.className} h-screen w-full bg-[#F2EFE9] text-black overflow-hidden flex flex-col justify-between`}>
      
      {/* ESTILOS INTERNOS (SOLUCIÓN AL ERROR):
         Usamos una etiqueta style normal para inyectar el CSS de las animaciones
         sin que TypeScript se queje del atributo 'jsx'.
      */}
      ...
      <footer className="w-full py-2 text-center">
        <p className={`${fontTitulo.className} text-xl text-black/30`}>PANDA DJ</p>
